...
Shader "Sunao Shader/[Stencil Outline]/Transparent" {
	...
	Properties {
		...
		[SToggle]
		_VertexColor      ("Enable Vertex Color"  , int) = 0
		...
		[SToggle]
		_SpecularTexColor ("TexColor for Specular", int) = 0
		[SToggle]
		_MetallicTexColor ("TexColor for Metallic", int) = 1
		[SToggle]
		_MatCapTexColor   ("TexColor for MatCap"  , int) = 0
		[SToggle]
		_SpecularSH       ("SH Light Specular"    , int) = 1
		[Enum(None , 0 , RealTime , 1 , SH , 2 , Both , 3)]
		_ReflectLit       ("Reflection Lighthing" , int) = 0
		[Enum(None , 0 , RealTime , 1 , SH , 2 , Both , 3)]
		_MatCapLit        ("MatCap Lighthing"     , int) = 3
		[SToggle]
		...
		[SToggle]
		_RimLitLighthing  ("Use Lighthing"        , int) = 1
		[SToggle]
		...
		[HideInInspector] _ShadingFO       ("Shading FO"        , Range(0.0, 1.0)) = 0.0
		[HideInInspector] _OutlineFO       ("Outline FO"        , Range(0.0, 1.0)) = 0.0
		[HideInInspector] _EmissionFO      ("Emission FO"       , Range(0.0, 1.0)) = 0.0
		[HideInInspector] _ReflectionFO    ("Reflection FO"     , Range(0.0, 1.0)) = 0.0
		[HideInInspector] _RimLightingFO   ("Rim Lighting FO"   , Range(0.0, 1.0)) = 0.0
		[HideInInspector] _OtherSettingsFO ("Other Settings FO" , Range(0.0, 1.0)) = 0.0
